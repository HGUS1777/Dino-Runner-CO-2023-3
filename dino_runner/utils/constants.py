...
# Assets Constants
ICONS = pygame.image.load(os.path.join(IMG_DIR, "DinoWallpaper.png"))
...
CLOUD = [
    ...
    pygame.image.load(os.path.join(IMG_DIR, 'Other/Cloud_2.png')),
    pygame.image.load(os.path.join(IMG_DIR, 'Other/Cloud_3.png'))
]
